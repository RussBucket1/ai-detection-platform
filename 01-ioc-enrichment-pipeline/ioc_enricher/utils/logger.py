...
def configure_logging(log_level: str, *, json_logs: bool = True) -> None:
    ...
    In production (json_logs=True), emits JSON lines with ISO UTC timestamps.
    In development, emits colored console output. Suppresses noisy third-party loggers.
    """
    ...
    for noisy in ("aiohttp", "asyncio", "urllib3", "aiohttp.access", "aiohttp.server"):
